...
```text
ให้รับinputคือค่าอาหารเครื่องดื่ม outputคือหลังจากคำนวนค่าบริการและภาษีแล้ว มีเงื่อนไขตรงค่าบริการที่ต้องอย่างน้อย50และไม่เกิน1000และvatที่ต้องนำไปคำนวนหลังจากรวมค่าอาหารกับค่าบริการแล้วถึงจะprintผลรวมออกมาได้
```
...
Step 2:นำไปคำนวนค่าบริการและภาษี
Step 3:printออกมาหลังคำนวนและทำเป็นทศนิยม2ตำแหน่ง
```
...
```text
เหมือนกันแต่มีเพิ่มตรงเงื่อนไขค่าบริการอย่างต่ำ50และไม่เกิน1000ด้วยแล้วก็ติดตรงคำนวน
```
...
```text
เทสว่าได้printออกมาเป็นทศนิยม2ตำแหน่งรึป่าว
```
...
```text
เช็คว่าได้กำหนดค่าขั้นต่ำของค่าบริการไว้รึป่าว
```
...
```text
เช็คว่าได้ทำสูตรคำนวนครบรึป่าว
```
...
| Statement | Yes/No |
|---|---|
| I wrote this submission in my own words. |ํYes |
