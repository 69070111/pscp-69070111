...
```text
คิดคำนวนตรงค่าภาษีกับเงื่อนค่าบริการที่ต้องเป็นอย่างน้อย50และไม่เกิน1000
```
...
```text
เข้าใจผิดเกี่ยวกับโจทย์ ตอนแรกฉันเข้าใจว่าให้คำนวนทั้งหมดทีเดียวเลย แต่จริงๆแล้วต้องคำนวนค่าของกับค่าบริการก่อนถึงจะเอาไปบวกกับค่าvatที่คำนวนมาแล้ว และช่วยให้เก็ทเรื่องค่าบริการขั้นต่ำด้วย
```
...
```text
ตรวจว่าต้องทำเงื่อนไขค่าบริการยังไงและเปลี่ยนวิธีคำนวนค่าvatกับค่าของและค่าบริการว่าต้องคำนวนค่าของและค่าบริการก่อนถึงนำไปบวกกับค่าvat
```
...
```text
ช่วยให้ฉันสังเกตโจทย์มากขึ้นช่วยให้นึกขึ้นได้ถึงการทำเงื่อนไขโดยใช้ifเพื่อแก้ปัญหาตรงค่าบริการและช่วยเรื่องการคำนวนภาษีด้วยทำให้ต้องกลับไปนั่งคิดว่าตัวเราน่าจะอ่านโจทย์ไม่ละเอียดเอง
```
