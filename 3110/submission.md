...
```text
รับinputบรรทัดแรกเป็นstrบรรทัดที่สองเป็นfloatหลังจากนั้นเช็คว่าลูกค้ามีต้นทางปลายทางที่ไหนและระยะทางเท่าไหร่และนำไปคำนวนต่อถ้าไม่ตรงให้ขึ้นError
```
...
```text
Step 1:รับinputสองบรรทัด3ตัวบรรทัดแรกเป็นstrบรรทัดที่สองเป็นfloat
Step 2:นำเข้าif elif ว่าต้นทางปลายทางตรงกับอันไหนและนำน้ำหนักไปคูณค่าธรรมเนียมน้ำหนักบวกด้วยค่าธรรมเนียมเริ่มต้น
Step 3:printสิ่งที่คำนวนได้ออกมาถ้าไม่ตรงเงื่อนไขเลยให้ขึ้นError
```
...
```text
เหมือนแผนแรกเพราะนำเข้าเช็คif elif และนำไปคูณไปบวกเหมือนเดิม
```
...
```text
ได้พิมพ์Errorเวลาเงื่อนไขไม่ตรงรึป่าว
```
...
```text
เช็คว่าได้บวกค่าธรรมเนียมเริ่มต้นมั้ย
```
...
```text
ได้แปลงค่าเป็นfloatไหมตอนinput
```
