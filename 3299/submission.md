...
```text
ให้คำนวนหาว่าถ้าปลูกผักเป็นแนวทะแยงตามจำนวนlเนี่ยแล้วปลูกตั้งแต่1จนถึงnแล้วตัวสุดท้ายจะอยู่บรรทัดไหน
```
...
```text
Step 1:รับค่าโดยใช้mapกับsplit
Step 2:คำนวนหาแถวแรกก่อนหลังจากนั้นคำนวนโดยใช้whileloopต่อโดยloopจนถึงจำนวนnแล้วจึงนับว่ามีกี่บรรทัด
Step 3:printออกมาว่ามีกี่บรรทัด
```
...
```text
เหมือนกันแต่วิธีคำนวนตอนแผนแรกนั้นไม่ถูก
```
