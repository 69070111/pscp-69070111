...
| Item | Answer |
|---|---|
| OJ problem number/title | 3072/A-E-I-O-U |
| OJ submission ID, if submitted | 573682 |
| OJ status | Pass |
...
```text
ถามวิธีการใช้dictและให้สอนใช้.item
```
...
```text
วิธีในการใช้.itemควบคู่กับdictที่สร้างขึ้นมา
```
...
```text
นำวิธีการใช้.itemมาใช้ควบคู่กับdictโดยในforloopและสร้างตัวแปรสองตัวเพื่อให้เชื่อมกับdictและใช้.itemเพื่อให้รู้ว่าให้แปลงเป็นข้อมูลในdictนะ
```
...
```text
วิธีในการใช้คำสั่ง.itemควบคู่กับdictและforloop
```
