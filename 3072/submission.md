...
```text
รับinputมาเป็นประโยคหลังจากนั้นนับว่าในประโยคมีสระเท่าไหร่
```
...
```text
Step 1:รับinputเป็นstr
Step 2:ใช้dictควบคู่กับforloopเพื่อเช็คว่าถ้ามีตัวอักษรนี้ในประโยคนี้มั้ยถ้ามีก็printออกมาถ้าไม่มีก็ไม่ต้องprint
Step 3:printจำนวนสระที่มีมากกว่า0
```
...
```text
เหมือนเดิมเพราะใช้dictควบคู่กับforloop
```
...
```text
เช็คว่าinputได้ใส่.lowerรึป่าว
```
...
```text
ได้ใช้printfและเขียนเว้นวรรคถูกรึป่าว  
```
...
```text
ตัวที่เป็น0ได้ปริ้นออกมารึป่าว
```
