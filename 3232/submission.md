...
```text
ดูว่ากบกระโดดไปกี่ทีโดยที่จะมีค่าxเป็นความไกลการกระโดดแต่ละทีyคือเป้าหมายที่อยากไปถึงโดยที่การกระโดดแต่ละทีจะทำให้ระยะการกระโดสั้นลง2เมตร
```
...
```text
Step 1:รับค่าxyมาประกาศตัวแปรระยะทางและจำนวนที่กระโดด
Step 2:ใช้whileloopเพื่อหาโดยที่บวกค่าxเข้าไปเรื่อยๆและloopถัดไปจะโดดสั้นลง2เมตรและบวกจำนวนที่กระโดดไปทั้งหมดและถ้าตัวแปรระยะทางมากกว่าเท่ากับyจะจบloop
Step 3:printจำนวนที่กรโดดทั้งหมด
```
...
```text
เหมือนเดิมเพราะใช้whileloopเหมือนที่เขียนไว้
```
...
```text
เช็คว่าถ้าไม่ถึงจะprintอะไรออกมา
```
