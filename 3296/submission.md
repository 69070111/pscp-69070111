...
```text
ให้หาค่าเฉลี่ยของสีทั้งสองอันตั้งแต่r, g, bเลย
```
...
```text
Step 1:รับinput2บรรทัดโดยใช้splitกับmapช่วย
Step 2:คำนวนหาค่าเฉลี่ยของแต่ละสีทั้งสองบรรทัด
Step 3:printค่าเฉลี่ยออกมา
```
...
```text
เหมือนกันเพราะคำนวนและใช้การรับinputเหมือนกัน
```
