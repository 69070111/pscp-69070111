...
| Item | Answer |
|---|---|
| OJ problem number/title | 3025/Season |
| OJ submission ID, if submitted | 550391 |
| OJ status | Pass |
...
```text
ฉันถามว่าการที่จะทำเงื่อนไขวันที่21และเดือนที่3ของฤดูนั้นๆจะเป็นฤดูถัดไปยังไง
```
...
```text
ทำให้ฉันได้รู้จักกับการใช้%เพื่อหาเดือนที่หาร3ลงตัว
```
...
```text
ใช้คำแนะนำที่ใช้ให้ใช้%3 คู่กับเงื่อนไขifซ้อนifและเช็คว่าวันที่นั้นมากกว่าเท่ากับ21ไหมและ เดือนหาร3ลงตัวไหมถ้าตรงเงื่อนไขให้ไปที่ฤดูของเดือนถัดไปถ้าไม่ตรงให้เป็นฤดูของเดือนนั้นๆ
```
...
```text
ได้เรียนรู้การใช้%3และการใช้เงื่อนไขifซ้อนifยังไงให้คล่องมากขึ้น
```
