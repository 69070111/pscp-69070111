...
```text
โจทย์ให้รับinput2อันอันแรกก็คือเดือนอันที่สองก็คือวันและนำไปหาว่าวันนี้เดือนนี้คือฤดูอะไรโดยการใช้if elseถ้าอยู่ในเดือนไหนก็เป็นฤดูนั้นแต่ว่าถ้าเกินวันที่21ของเดือน3ในฤดูนั้นแล้วต้องเป็นฤดูถัดไปแทนโดยการใช้ if วัน >= 21 และเดือนต้องการ3ลงตัวถึงจะเป็นเดือนถัดไปของฤดูนั้นๆ
```
...
```text
Step 1:รับinputสองตัวได้แก่เดือนและวัน
Step 2:หลังจากนั้นนำมาเข้าif elseถ้าตรงกับเดือนไหนให้เป็นฤดูนั้นๆ
Step 3:printฤดูหลังจากนำเข้าเงื่อนไขมาแล้ว
```
...
```text
คล้ายๆแผนแรกแต่เพิ่มเงื่อนไขของวันที่21ของเดือนที่3ของฤดูนั้นๆโดยใช้if ซ้อนif 
```
...
```text
เช็คว่าได้เข้าเงื่อนไขหลังจากวันที่21และเดือนที่3ของฤดูนั้นๆรึยัง
```
