...
```text
โจทย์ให้รับค่ามาเป็นจำนวนร้านและจำนวนร้านที่ต้องการตรวจโดยจะมีบอกเวลาการเปิดและปิดของร้านและรับค่าเวลาที่ต้องการตรวจและตรวจว่าตอนนั้นมีร้านอะไรเปิดอยู่บ้าง
```
...
```text
Step 1:รับค่ามาสองค่าหลังจากนั้นใช้forloopรับค่าnumมารับค่าเวลาที่ต้องการตรวจมา
Step 2:หลังจากนั้นใช้forloopเช็คทีละร้านเวลาเปิดอยู่รึป่าวถ้าเปิดอยู่ให้+=1
Step 3:printจำนวนร้านที่เปิอดอยู่ตอนนั้นทั้งหมดมา
```
...
```text
ไม่เหมือนวิธีแรกเลยเนื่องจาการใช้forlooทำให้เปิดtimeoutเลยเปลี่ยนไปใช้listแทนโดยรับค่าคล้ายๆๆวิธีแรกใช้for loopรับค่าของเวลาที่ร้านเปิดมาก่อนหลังจากนั้นใช้forloopอีกทีนึง+=1ในตำแหน่งตั้งแต่startถึงstopและรับค่าเวลาที่เดินตรวจมาและวนลูปprintเวลาที่ตรวจเช็คว่าร้านในเวลาตรวจเปิดรึป่าว
```
...
```text
เข้าเงื่อนไขและไม่ติดtimeoutใช่มั้ย
```
...
```text
เข้าเงื่อนไขทุกอันและตรวจการตรวจเวลาว่าตรงรึป่าว
```
...
```text
เปลี่ยนจากการลูปบวกเข้าเป็นเป็นใช้listแทน
```

คุณยังทำอะไรด้วยตนเอง

```text
แก้ไขการloopเปลี่ยนเป็นสistเนื่องจากเพื่อนแค่แนะนำวิธีทำไม่ได้บอกวิธีเขียน
```
