...
```text
รับinput4ตัวโดยที่หาว่าตั้งแต่aถึงbนั้นเอาไปหารdแล้วเหลือเศษrกี่ตัวบ้าง
```
...
```text
Step 1:รับinput4ตัวเป็นa, b, d, r
Step 2:นำเข้าforloopเช็คตั้งแต่a,bว่ามีกี่ตัวที่หารdแล้วเหลือเศษrโดยตั้งตัวแปรใหม่เพื่อมานับว่ามีกี่ตัว
Step 3:printจำนวนที่หารdแล้วเหลือเศษr
```
...
```text
เหมือนแผนแรกเพราะใช้forloopแล้วคำนวนออกมาตามที่คิดไว้ตอนแรก
```
...
```text
ได้ใส่+1ต่อหลังตัวแปรbในforloopรึป่าว
```
