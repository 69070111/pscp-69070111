...
| Item | Answer |
|---|---|
| OJ problem number/title | 3036/ปราสาท |
| OJ submission ID, if submitted | 589005 |
| OJ status | Pass |
...
```text
สอนการหาชั้นว่าตอนนี้ตัวเองอยู่ชั้นไหนแล้วพอหาและบอกว่าต้องมีเงื่อนไขสามเหลี่ยมคว่ำด้วย
```
...
```text
สังเกตว่าแต่ละชั้นนั้นคือเลขชั้นยกกำลังสอง
```
...
```text
เขียนวิธีคำนวนว่าต้องไปแต่ละชั้นยังไง
```
...
```text
การที่ทำให้สังเกตมากขึ้นการคำนวนหาเลขชั้น
```
