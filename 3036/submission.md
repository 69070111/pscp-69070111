...
```text
รับinputเป็นชั้นที่อยู่ปัจจุบันหลังจากนั้นให้หาว่าวิธีไปยังห้องเลข1นั้นไปยังไงให้ไวที่สุดโดยที่ต้องมองก่อนว่าแต่ละชั้นนั้นจำนวนห้องขึ้นอยู่กับเลขห้องยกกำลังสองและจะมีบางห้องที่ห้องนั้นเป็นสามเหลี่ยมคว่ำและบางห้องเป็นสามเหลี่ยมหงายโดยที่ชั้นคู่ห้องคี่หรือห้องคี่ชั้นคู่จะเป็นสามเหลี่ยมคว่ำต้องนำไปลบ1ด้วยโดยที่วิธีหาว่าแต่ละชั้นไปต้องผ่านกี่ห้องคือต้องคิดว่าถ้าเป็นสามเหลี่ยมคว่ำจะใช้รอบเดียวถ้าเป็นสามเหลี่ยมหงายจะต้องผ่าน2ห้อง
```
...
```text
Step 1:รับinputเป็นint
Step 2:นำintputที่ได้มาหาว่าเราอยู่ตรงนี้ต้องไปกี่ชั้นและคำนวน
Step 3:หลังจากคำนวนก็printออกมา
```
...
```text
คล้ายๆวิธีแรกแต่ตอนคิดวิธีแรกยังไม่รู้ว่าต้องคำนวนยังไงและไม่ได้คำนึงถึงสามเหลี่ยมคว่ำหรือหงายเลยโดยนำไปคิดก่อนว่าห้องนี้เป็นสามเหลี่ยมหงานหรือคว่ำแล้วก็นำไปคำนวนต่อว่าต้องผ่านกี่ชั้น
```
...
```text
เช็คว่าได้คิดสามเหลี่ยมคว่ำรึป่าว
```
...
```text
เงื่อนไขห้องคี่ชั้นคู่หรือห้องคู่ชั้นคี่ได้ใส่มามั้ย
```
...
```text
บอกวิธีมองการทำโจทย์ให้มองแต่ละชั้นเป็นเลขชั้นกำลังสอง
```

คุณยังทำอะไรด้วยตนเอง

```text
นำวิธีการมองเลขนั้นไปคำนวนต่อและคิดวิธีสามเหลี่ยมคว่ำสามเหลี่ยมหงาน
```
