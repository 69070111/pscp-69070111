...
```text
รับประโยคมาและครอบข้อความนั้นด้วย*เป็นกรอบรูป
```
...
```text
Step 1:รับค่ามา5ค่า
Step 2:หลังจากนั้นสร้างลิสนับจำนวนตัวอักษรและสร้างลิสใส่ตัวอักษรเข้าไป
Step 3:printกรอบรูปบนและกรอบรูปล่างส่วนตรงกลางสร้างลูปสร้างforloopหาพื้นที่ว่างข่างหลังตัวอักษรและคูณstrกับช่องว่าง
```
...
```text
เหมือนวิธีแรกเพราะใช้forloopเหมือนกัน
```
...
```text
ลองcaseว่าใส่คำสั่งstripไปรึป่าว
```
...
```text
ถ้าไม่มีอะไรเลยจะออกมาเป็นอะไร
```
