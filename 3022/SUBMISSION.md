...
```text
รับค่าตัวแรกมาเป็นอุณหภูมิเป็นfloatตัวต่อมาเป็นค่าอุณหภูมิปัจจุบัน และอันสุดท้ายคืออุณหภูมิที่ต้องการเปลี่ยนเป็น หลังจากรับinputอันแรกให้นำเลขเปลี่ยนจากอุณหภูมิเริ่มต้นก็คือinputอันที่สองเปลี่ยนเป็นหน่วยอุณหภูมิก็คือinputอันที่สามโดยการใช้match caseเปลี่ยนค่าอุณหภูมิให้เป็นcทั้งหมดก่อนหลังจากนั้นใช้matchอีกรอบเพื่อเปลี่ยนเป็นหน่วยอุณหภูมิที่ต้องการ
```
...
```text
Step 1:รับinput3อัน
Step 2:แปลงค่าด้วยifelse16รอบถ้าตัวแรกกับตัวที่สองตรงเงื่อนไขก็จะให้แปลงค่าตามที่inputมา
Step 3:printค่าหลังจากแปลงค่ามาแล้ว
```
...
```text
เปลี่ยนจากการใช้ifelseในเงื่อนไขเป็นmatchcaseเพื่อแปลงค่าที่ได้มาเป็นcก่อนแล้วค่อยเปลี่ยนเป็นค่าที่ต้องการในinput3อีกที
```
...
```text
เช็คว่าถ้าเปลี่ยนค่าจากcเป็นcมันเท่าเดิมรึป่าว
```
...
```text
เช็คว่าได้ใส่ทศนิยมสองจุดรึป่าว
```
...
```text
บอกวิธีการใช้matchcase
```

คุณยังทำอะไรด้วยตนเอง

```text
นำmatchcaseไปช่วยในการคำนวนว่าต้องนำcไปแปลงค่าก่อนแล้วค่อยนำไปแปลงเป็นค่าที่ต้องการอีกที
```
