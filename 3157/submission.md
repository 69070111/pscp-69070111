...
```text
จะมีค่ามาค่านึงก็คือคนทั้ังหมดที่นั่งเป็นวนกลมและจะมีของขวัญหนึ่งชิ้นและโจรโดยที่ถ้าของขวัญหมุนจนถึงคนสุดท้ายแล้วนั้นจะส่งวนเป็นวงกลมโดยถ้าของขวัญไปตกยังคนที่1หรือของขวัญไปตกที่โจรนั้นจะจบการนับทันทีโดยที่โจทย์ต้องการคือจำนวนคนทั้งหมดที่ได้ดูของขวัญข้างในนั้นโดยวิธีการส่งของขวัญก็คือส่งข้ามไปตามจำนวนKครั้ง
```
...
```text
Step 1:รับค่าn, k, tก็คือคนทั้งหมด, การส่งข้ามแต่ละรอบส่งกี่ที, โจรอยู่คนที่เท่าไหร่
Step 2:ใช้whileloopเพื่อเช็คเงื่อนไขโดยที่เช็คก่อนว่าโจรอยู่ต่ำแหน่งที่tรึป่าวหลังจากนั้นก็ส่งของขวัญตามจำนวนkและเช็คว่าถ้าเกินจำนวนคนนั้นจะวนกลับมาที่คนที่หนึ่งด้วยและบวกจำนวนเช็คว่ามีคนได้เปิดดูของขวัญไปแล้วกี่คนและใส่เงื่่อนไขถ้าวนกลับมาคนที่หนึ่งนั้นให้ออกลูปด้วย
Step 3:printจำนวนคนที่ได้เปิดของขวัญไปทั้งหมด
```
...
```text
เหมือนวิธีแรกแต่ว่าตอนแรกจะเปลี่ยนไปใช้forloopแต่เหมือนจะไม่ได้เลยใช้whileloopเหมือนเดิม
```
...
```text
ได้เช็ครึป่าวว่าโจรนั้นอยู่ต่ำแหน่งแรกรึป่าว
```
...
```text
ได้บวกจำนวนโจรไปตอนที่โจรเจอของขวัญแล้วหนีไปไหม
```
...
```text
ได้วนลูปเป็นวงกลมและทำตามเงื่อนไขไหม
```
