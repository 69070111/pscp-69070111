...
```text
รับinputมาสองอันก็คืออิฐเล็กและอิฐใหญ่และอิฐใหญ่มีความยาว5นิ้วอิฐเล็กยาวแค่1นิ้วหลังจากนั้นหาว่าต้องใช้อิฐเล็กเท่าไหร่โดยวางอิฐใหญ่ก่อนถ้าอิฐใหญ่เกินให้ใช้อิฐเล็กมาแทนถ้าอิฐเล็กใช้ไม่ได้ให้ตอบ-1
```
...
```text
Step 1:รับinputสองอันอิฐเล็กกับใหญ่
Step 2:นำอิฐใหญ่ไปลบกับจำนวนgoalเสร็จแล้วนำไปคำนวนต่อว่าช่องที่เหลือคือเท่าไหร่หลังจากนั้นก็เอาอิฐเล็กไปใส่
Step 3:printอิฐเล็กที่ต้องใช้
```
...
```text
ไม่คล้ายกับแผนแรกเลยนำไปคิดก่อนว่าอิฐใหญ่ใช้ได้กี่ก้อนโดยเอาไปหารไม่เอาเศษกับ5หลังจากนั้นคิดก่อนว่าระหว่างที่คำนวนมากับอิฐใหญ่เริ่มต้นเนี่ยอันไหนน้อยกว่ากันอันไหนน้อยกว่าก็เอาอันนั้นโดยใช้minพอเช็คเสร็จแล้วก็เอาอันที่น้อยที่สุดมาคูณ5และนำไปลบกับอิฐเล็กเสร็จแล้วเช็คว่าถ้าอิฐเล็กไม่พอให้print-1ถ้าพอให้printเลขที่คำนวนออกมา
```
...
```text
ถ้าอิฐเล็กไม่พอได้print-1รึป่าว
```
...
```text
ได้นำไปหารก่อนรึป่าวว่าอิฐใหญ่ใส่ได้กี่ก้อน
```
...
```text
พอคำนวนเสร็จแล้วได้เอาไปลบกับอิฐเล็กรึป่าว
```
