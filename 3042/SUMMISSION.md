...
```text
โจทย์นี่้จะนำเลขเข้ามาหนึ่งinputและนำเข้าforloopเพื่อวนจำนวนเลขโดยในindexคือnum, -1เพื่อให้จบที่0และ, -1เพื่อให้นับถอยหลัง
และเข้าเงื่อนไขถ้าหาร10ลงตัวก็ให้printตัวนั้นออกมาและจบด้วย end = " "
```
...
```text
Step 1:รับinput
Step 2:นำเข้าforloopและใช้indexเพื่อนับเลขถ้าเลขไหนในindexหาร10ลงตัว
Step 3:เสร็จแล้วprintเลขที่หาร10ลงตัวพร้อมให้อยู่บรรทัดเดียวกัน
```
...
```text
เหมือนกันเพราะตอนแรกแผนแรกคือใช้forloopต่อมาคิดว่าจะใช้whileloopแต่ว่ารู้สึกว่าforloopดีกว่า
```
...
```text
เช็คว่ามี0อยู่ตัวสุดท้ายรึป่าว
```
...
```text
เช็คว่าถ้าเข้าเงื่อนไขว่าต้องหาร10ลงตัวไหม
```
...
```text
เช็คว่าได้เรียงoutputจากน้อยไปมากไหม
```
