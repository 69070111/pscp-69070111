...
| Item | Answer |
|---|---|
| OJ problem number/title | 3031/ink |
| OJ submission ID, if submitted | 588844 |
| OJ status | Pass |
...
```text
ให้ช่วยเรื่องบอกสูตรการคำนวนหาพื้นที่
```
...
```text
การใช้สูตรหาพื้นที่เป็นr**2 = x**2 + y**2
```
...
```text
หลังจากหาพื้นที่แล้วโจทย์ต้องการหาเวลาเลยเอาพื้นที่หารเวลาการเคลื่อนที่ของหมึก
```
...
```text
เรียนรู้เรื่องการใช้สูตรในการหารัศมีของบ้านคนและเอไอยังแนะนำให้ใช้.celiเพื่อปัดเลขอีกด้วย
```
