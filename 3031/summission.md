...
```text
inputคือsจำนวนวินาทีที่หมึกขยายต่อวินาทีnคือจำนวนคำร้องผู้คนโดยเอาจำนวนคำร้องผู้คนไปเข้าลูปเพื่อรับinputของพิกัดบ้านคนอีกทีโดยหาพื้นที่ของคนโดยการใช้สูตรหารัศมีเสร็จแล้วให้นำไปหารกับเวลาจะได้เวลาที่หมึกเดินทางไปถึงบ้านคนๆนั้นมา
```
...
```text
Step 1:รับอินพุดเข้ามาโดยใช้splitคู่ด้วย
Step 2:นำเข้าfor loopและนำไปคำนวนจนได้สิ่งที่ต้องการมา
Step 3:printสิ่งที่คำนวนมาแล้ว
```
...
```text
คล้ายกับแผนแรกแต่ตอนคิดแผนแรกคิดวิธีคำนวนไม่ออก
```
