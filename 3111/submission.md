...
```text
การลดราคาของนักเรียนถ้าเข้าเงื่อนไขก็ลดราคาตามเงื่อนไข
```
...
```text
Step 1:รับค่าสองอันและอันอันที่สามใช้forloop
Step 2:หลังจากนั้นนำไปเข้าเงื่อนไขว่าตรงเงื่อนไขไหนถ้าตรงให้ลดราคาตามเงื่อนไขนั้นๆ
Step 3:printจำนวนยอดหลังจากหักส่วนลด
```
...
```text
เหมือนแผนแรกแต่มีแก้ไขยอดสุทธิหลังหักส่วนลด ด้วยทศนิยม 2 ตําแหน่ง
```
...
```text
คำนวนถูกและใส่ค่าทศนิยมถูกมั้ย
```
