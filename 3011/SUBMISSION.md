...
```text
inputมี2อัน outputทำการเช็คinput1กับ2ว่าเข้าเงื่อนไขไหมถ้าเข้าเงื่อนไขให้printออกมาตามเงื่อนไขถ้าinputไม่ตรงให้print error
```
...
```text
Step 1:รับinput2อัน
Step 2:ใช้ifและelifเช็คว่าถ้าตรงตามเงื่อนไขจะเป็นสีนั้นนะ
Step 3:printสีที่ผสมมา
```
...
```text
รับinput2อันใช้ifและelifเช็คสีตอนผสมว่าสีinput1กับinput2ได้ออกมาเป็นสีอะไรและสลับinput1กับinput2ด้วยเพื่อตอนเช็คจะได้เช็คถูกและใส่errorถ้าinputไม่ตรงด้วยหลังจากเช็คinputแล้วprintออกมา
```
...
```text
เช็คว่าได้เพิ่มเงื่อนไขสลับinputรีป่าว
```
...
```text
เช็คว่าเวลาใส่สีซ้ำกันจะออกมาเป็นสีเดิมไหม
```
...
```text
เช็คว่าได้ทำตามเงื่อนไขErrorไหม
```
...
```text
บอกว่าตอนใส่เงื่อนไขใส่เงื่อนไขซ้ำกันทั้งสองฝั่งทำให้ไม่ขึ้นตามเงื่อนไขที่ใส่
```

คุณยังทำอะไรด้วยตนเอง

```text
แก้ไขโค้ดตรงที่ผิดและเพิ่มเงื่อนไขตอนเช็คสี
```
