...
```text
โจทย์ให้ข้อมูลinputมาให้โดยนำตัวย่อมาทำให้เป็นตัวเต็ม
```
...
```text
Step 1:รับค่ามาstr สองค่า
Step 2:ใช้match caseในการจับคู่
Step 3:printตัวเต็มออกมา
```
...
```text
ใช้dictในการทำและพอนำมาหาค่าใช้indexและ.getในการดึงค่าออกมา
```
...
```text
บอกวิธีการใช้dictและ.get
```

คุณยังทำอะไรด้วยตนเอง

```text
ลองใช้dictด้วยตัวเองจากคำแนะนำของเพื่อน
```
