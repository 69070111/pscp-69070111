...
```text
โจทย์ให้รับค่ามาสองตัวก็คือเลขตัวแรกถึงตัวสุดท้ายและให้เช็คว่าตั้งแต่ตัวแรกถึงตัวสุดท้ายนั้นมีจำนวนเฉพาะอะไรบ้างและมีกี่ตัว
```
...
```text
Step 1:รับค่ามาสองค่าก็คือค่าเริ่มต้นและค่าสิ้นสุด
Step 2:ใช้forloopรอบแรกหลังจากนั้นหาเงื่อนไขของการหาจำนวนเฉพาะมา
Step 3:printจำนวนเฉพาะทั้งหมดมาและมีจำนวนเฉพาะกี่ตัว
```
...
```text
ต่างกันตรงเงื่อนไขใช้forloopรอบแรกคือการวนตัวแรกตั้งแต่ตัวแรกถึงตัวสุดท้ายและใช้if i > 1เพราะจำนวนเฉพาะจะมากกว่า1และใช้forloopอีกทีนึงตั้งแต่เลข2จนถึงสแควรูทiก็เพราะถ้าหารสแวครูทiลงตัวจะไม่ใช่จำนวนเฉพาะส่วนตัวที่หารไม่ลงตัวนั้นจะเป็นจำนวนเฉพาะทั้งหมดเลยก็เลยเป็นถ้า i % jไม่ลงตัวก็จะเป็นจำนวนเฉพาะและ.appendเข้าไปในlistและนับtotalทั้งหมด
```
...
```text
เช็คว่าตรวจหาจำนวนเฉพาะถูกมั้ย
```
...
```text
ได้printแบบไม่เอาวงเล็ปของlistออกมั้ย
```
