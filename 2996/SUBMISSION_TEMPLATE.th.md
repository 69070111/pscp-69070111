...
```text
ให้กรอกinputที่เป็นตัวอักษรเรื่อยๆถ้าตัวอักษรที่กรอกมามี5ตัวพอดีโดยใช้whileloopในวนข้อความแล้วใช้lenในการเช็คจำนวนตัวอักษรและให้prinออกมาแล้วเวลาprintให้printกลับหลังโดยใช้ตัวindexในการเช็คโดยที่เริ่มจากตัวแรกจบที่ช่องสุดท้ายแล้วนับถอยหลังโดยstepคือ-1และใช้.lowerในการทำให้ตัวอักษรทั้งหมดเป็นตัวเล็ก
```
