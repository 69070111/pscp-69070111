...
```text
โจทย์ให้เช็คตว่าถูกหวยมั้ยโดยเช็คไปทีละเงื่อนไขไปเลยเช่นถูกหมด ถูกแค่สองตัวท้าย หรือ ถูกแค่ตัวอักษร
```
...
```text
Step 1:รับค่ามาสองค่า ประกาศตัวแปรผลรางวัลที่จะได้
Step 2:ใช้ifelseเช็คไปทีละเงื่อนไขตามที่โจทย์กำหนดมาโดยใช้indexในการช่วย
Step 3:printจำนวนเงินที่จะได้
```
...
```text
เหมือนวิธีแรกเพราะว่าใช่ifelseและindexในการตรวจเงื่อนไข
```
...
```text
เช็คว่าถ้าไม่ถูกเลยจะprint0มั้ย
```
...
```text
ถ้าถูกเลขท้ายสองตัวและตัวอักษรไม่ถูกจะได้เท่าไหร่
```
