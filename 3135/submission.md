...
```text
มีค่าๆนึงเป็น0ตอนแรกและให้รับinputเป็นเลขก่อนตอนแรกก็คือจำนวนที่จะบวกหรือลบถ้าเป็นบวกจะบวก10ถ้าเป็นลบจะลบ5แล้วprintค่าทั้งหมดที่ได้ตอนท้าย
```
...
```text
Step 1:รับinputเป็นintแล้วลูปตามจำนวนเลขที่กรอกเข้ามาเป็นstrก็คือ+หรือ-
Step 2:คำนวนตามที่โจทย์ให้มาโดยใช้if elifก็คือถ้าเป็น+จะบวก10ถ้าเป็น-จะลบ5
Step 3:printเลขทัั้งหมดหลังจากคำนวนแล้ว
```
...
```text
เหมือนกันเพราะได้ใช้forloopตามที่เขียนไว้ตอนแรก
```
...
```text
คำนวนถูกรึป่าวบวกลบตามเงื่อนไขแล้วรรึป่าว
```
