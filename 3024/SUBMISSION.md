...
```text
รับinputมาสองอันอันแรกเป็นเลขคะแนนรวมของทั้ง3กรรมการอันที่สองคือคะแนนสูงสุดจากสามคะแนนนั้น
```
...
```text
Step 1: รับinputมาสองอัน
Step 2:นำinputแรกกับอันที่สองมาลบกันและนำไปหารสองหลังจากนั้นนำที่หารไปลบกับinputอันที่2
Step 3:แนะไปเช็คว่าที่นำมาลบกันมากกว่าสองรึป่าว
```
...
```text
เปลี่ยนจากการหารสองเป็นการนำค่ารวมกับค่าสูงสุดมาลบกันและนำค่าสูงสุดไปลบอีกทีและถ้าค่าต่ำสุดติดลบให้ทำค่าติดลบเป็น0แทนหลังจากนั้นนำค่าสูงสุดไปลบกับค่าต่ำสุดเพื่อหาว่าคะแนนนั้นห่างกันเกิน2รึป่าว
```
...
```text
เช็คว่าได้ทำให้ค่าต่ำสุดกลายเป็นลบรึป่าว
```
...
```text
บอกว่าการใช้/นั้นไม่ถูกต้องทั้งหมดต้องนำค่าทั้งหมดมาลบกับค่าสูงและลบกับค่าสูงสุดอีกทีเพื่อหาค่าที่ต่ำที่สุดหลังจากนั้นเพิ่มเงื่อนไขว่าค่าที่ต่ำที่สุดห้ามติดลบ
```

คุณยังทำอะไรด้วยตนเอง

```text
นำค่่าสูงสุดกับค่าต่ำสุดมาลบกันเพื่อหาว่าคะแนนแต่ละอันห่างกันมากแค่ไหน
```
